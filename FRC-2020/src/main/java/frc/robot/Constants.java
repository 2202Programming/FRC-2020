...
public final class Constants {
    ...
    public static final class InterstellarSettings {
      ...
      public static ShooterSettings ssZone1 = new ShooterSettings(32.0, 0, 48.7, VEL_TOL);  //vel, rps, angle, tol
      public static ShooterSettings ssZone2 = new ShooterSettings(36.0, 0, 40.5, VEL_TOL);  //vel, rps, angle
      public static ShooterSettings ssZone3 = new ShooterSettings(36.0, -10, 37.0, VEL_TOL);  //vel, rps, angle
      public static ShooterSettings ssZone4 = new ShooterSettings(39.0, 0, 40.0, VEL_TOL);  //vel, rps, angle
    }
