...
public class DriveWithLimelightToDistanceDegCmd extends CommandBase {
   ...
   * 
   */
  public DriveWithLimelightToDistanceDegCmd(final Mechanum_Drivetrain drive, final Lidar_Subsystem lidar,
  ...
  public DriveWithLimelightToDistanceDegCmd(Mechanum_Drivetrain drive, Lidar_Subsystem lidar, double stopDist, double maxSpeed, double angleTarget,
      double tolerancePct) {
