...
public class xmlParser {
  ...
  static boolean isWhitespaceNode(Node n) {
  ...
  static List<Node> removeWhitespaceNodes(NodeList nodes) {
  ...
  void buildCommands(CommandGroupBase group, Node nodElement) {
    Object[] cmdArray;
  ...
  Object[] parseCommand(Element cmdNode) {
    ...
    for (int i = 0; i < childNodes.getLength(); i++) {
      ...
      if ((child.getNodeType() == Node.ELEMENT_NODE) && (child.getNodeName() == ARG)) {
